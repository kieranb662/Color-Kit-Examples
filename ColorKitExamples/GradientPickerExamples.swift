...
let gradient1: [GradientData.Stop] = [
    .init(color: ColorToken(colorSpace: .sRGB, r: 252/255, g: 70/255, b: 107/255, a: 1), location: 0),
    .init(color: ColorToken(colorSpace: .sRGB, r: 63/255, g: 94/255, b: 251/255, a: 1), location: 1)]
let gradient2: [GradientData.Stop] = [
    .init(color: ColorToken(colorSpace: .sRGB, r: 63/255, g: 43/255, b: 150/255, a: 1), location: 0),
    .init(color: ColorToken(colorSpace: .sRGB, r: 168/255, g: 192/255, b: 255/255, a: 1), location: 1)
]
let rainbow: [GradientData.Stop] = [
    .init(color: ColorToken(colorSpace: .sRGB, r: 148/255, g: 0/255, b: 211/255, a: 1), location: 0),
...
struct AngularGradientExample: View {
    @ObservedObject var manager = GradientManager(
        GradientData(name: "My Gradient", stops: rainbow, center: .center, startAngle:  0, endAngle: 0.95)
    )
    @State var defaultColor: ColorToken = ColorToken(colorSpace: .sRGB, r: 0.2, g: 0.2, b: 0.4)
